  ...
  return (
    <div className="mb-40">
      ...
      <div className="mx-auto w-2/5 h-auto py-14">
        <p className="text-center text-2xl text-gray-800">Descubra nuestros servicios especializados que se adaptan a sus necesidades. Desde consultoría estratégica hasta soluciones a medida, estamos aquí para potenciar su éxito.</p>
      </div>

      <div className="mx-auto w-4/6 h-auto py-14 grid grid-cols-3 gap-20">
        <div className="z-0 grid place-items-center">
          <div className="">
            <Button className="h-fit w-60 p-0 rounded-2xl">
              <Image
                isZoomed
                width={240}
            ...
            <p className="h-44 text-justify text-base text-gray-800 px-14"> Nuestros servicios para eventos ofrecen opciones de menús personalizados y atención de primera clase para que su ocasión especial sea verdaderamente única. </p>
        </div>
        ...
        <div className="z-0 grid place-items-center">
          <div className="">
            ...
            <p className="h-44 text-justify text-base text-gray-800 px-14"> Un banquete de boda de ensueño: En nuestro restaurante, hacemos que su día especial sea aún más mágico con servicios personalizados para bodas.  </p>
        </div>
        ...
        <div className="z-0 grid place-items-center">
          <div className="">
            ...
            <p className="h-44 text-justify text-base text-gray-800 px-14"> Catering excepcional: Nuestros servicios de catering brindan una experiencia culinaria sobresaliente en cualquier lugar que elija. </p>
        </div>
