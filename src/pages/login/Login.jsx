import { Image, Link, Card, CardHeader } from "@nextui-org/react";
    ...
    <div className="flex flex-row font-marcellus">
          ...
          <div>
            ...
            <div className="flex flex-column">
              <form> {/* action="" */}
                ...
                <div>
                  <p className="text-white text-small">¿No tienes una cuenta? {' '}
      ...
      <div className="flex justify-center w-1/2" >
        <div className="relative">
          <div className="absolute z-50 inset-0 flex items-center justify-center bg-white bg-opacity-60">
